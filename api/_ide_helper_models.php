 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Office byHash(string $hash)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Office code(string $code)
 * @method static \Database\Factories\OfficeFactory factory($count = null, $state = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Office name(string $name)
