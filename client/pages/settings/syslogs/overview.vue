...
import { _dropShadow } from "#tailwind-config/theme";
  ...
  <Wrapper>
    ...
    <div class="grid grid-cols-2 gap-2">
      <template v-for="(level, index) in levelMap" :key="level">
        <div
          class="flex items-center gap-1.5 rounded border py-1 pl-2 pr-3 capitalize"
          :style="{
        ...
        >
          ...
          <TIcon :name="icons[index]" class="h-12 w-12" />
        </div>
      </template>
    </div>
  </Wrapper>
