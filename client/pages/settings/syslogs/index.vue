...
<template>
  <TTypography v-if="loading" class="px-3 py-6 text-center text-gray-400/50">
    Preparing viewer...
  </TTypography>
  <div
    v-else
    class="relative flex h-full max-h-full items-start divide-x divide-dark-100 overflow-x-auto dark:divide-gray-700"
  >
